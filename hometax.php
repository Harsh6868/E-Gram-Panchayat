...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tax_payments (owner_name, property_id, tax_amount, payment_method, transaction_id) VALUES ('$owner_name', '$property_id', '$tax_amount', '$payment_method', '$transaction_id')";
...
<div class="navbar">
    ...
    <form action="hometax.php" method="POST">
